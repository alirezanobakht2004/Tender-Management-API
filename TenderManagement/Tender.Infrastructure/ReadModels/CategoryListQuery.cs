// ================= Tender.Infrastructure/ReadModels/CategoryListQuery.cs
using System;
...
public sealed class CategoryListQuery : ICategoryListQuery
{
    private readonly IDbConnection _db;
    public CategoryListQuery(IDbConnection db) => _db = db;

    private const string Sql = "SELECT Id, Name FROM Categories ORDER BY Name";
